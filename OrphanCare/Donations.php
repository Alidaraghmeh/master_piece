				...
				<div class="viewContent">
					<div id='cssmenu'>
						<ul>
							...
							<li class="active"><a href='Donations.php'><span>Donations</span></a></li>
					...
					<div class="viewCon">
						<h3 class="title">Donations for us</h3>
						<div class='part1'>
							<?php
							$idOrph = $_SESSION["idOrph"];
							include("dbCon.php");

							$stmt = $db->prepare("SELECT * FROM donates WHERE idOrphanage = ?");
							$stmt->bind_param("i", $idOrph);
							$stmt->execute();
							...
							else
							{
								print("
									<table class='Volun'>
										<tr class='headT'>
											<td>Name</td><td>National ID</td><td>Phone</td><td>Email</td><td>Card Name</td><td>Card Number</td><td>The Amount</td>
										</tr>
								");
								while($donation = $result->fetch_assoc())
								{
									print("
										<tr class='bodyT1'>
											<td>".$donation['name']."</td>
											<td>".$donation['nationalID']."</td>
											<td>".$donation['phone']."</td>
											<td>".$donation['email']."</td>
											<td>".$donation['cardName']."</td>
