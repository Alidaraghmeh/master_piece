            ...
            <div class="content">
				<div class="viewContent">
					...
					<div class="viewCon">
						...
						<h3 class="title"><i class='fa fa-plus-circle'></i> Supervisor</h3>
						<div class='part1'>
							<?php
							include("dbCon.php");
							if(isset($_GET["idOrph"]))
							{
								$idOrph = $_GET["idOrph"];
								$nameOrph = $_GET["nameOrph"];
								print("
								<h4>Orphanage : $nameOrph .</h4>
								<form action='AddSupervisor.php' method='post' class='form'>
									<input type='hidden' name='idOrph' value='$idOrph' />
									<input type='hidden' name='nameOrph' value='$nameOrph' />
									<p>Name</p>
