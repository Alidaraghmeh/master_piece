        ...
        <section class="fill-height-or-more">
            ...
            <div class="content">
				<div class="viewContent">
					...
					<div class="viewCon">
						<span class="CreateBut"><a href='AddProduct.php'> <i class='fa fa-plus-circle'></i> Add </a></span>
						<h3 class="title">Our Products</h3>
						<div class='part1'>
							<?php
							$idOrph=$_SESSION["idOrph"];
							include("dbCon.php");
							$Pr="SELECT * FROM `products` WHERE `idOrph` = '$idOrph' ORDER BY id DESC";
										  ...
										  <div class='card'>
											...
											<div class='card-body'>
											  ...
											  <form action='deleteProduct.php' method='post' class='form'>
												...
												<input type='hidden' name='file' value='$Product[3]'>
