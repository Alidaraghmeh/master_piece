        ...
        <section class="fill-height-or-more">
            ...
            <div class="content">
				<div class="viewContent">
					<div id='cssmenu'>
						<ul>
							<li class="fir active"><a href='Supervisors.php'><span>Supervisors</span></a></li>
					...
					<div class="viewCon">
						<h3 class="title">Supervisors</h3>
						<div class='part1'>
							<?php
							$idOrph=$_SESSION["idOrph"];
							include("dbCon.php");
							$O="SELECT * FROM orphanageadmin WHERE idOrph='$idOrph'";
							...
							else
							{
								print("
									<table class='Volun'>
										<tr class='headT'>
											<td>Name</td><td>Phone</td><td>Address</td><td>Email</td>
										</tr>
								");
								while($Orph=mysqli_fetch_array($Or))
								{
									print("
										<tr class='bodyT1'>
											<td>$Orph[1]</td><td>$Orph[2]</td><td>$Orph[3]</td><td>$Orph[4]</td>
										</tr>
									");
								}
								print("
