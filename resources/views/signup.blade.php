                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('signup.store') }}" class="form">
                        ...
                        <div class="form-group">
                            <p>Name</p>
                            <input type="text" class="form-control border-dark @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}">
                            <!-- ... -->
                        </div>
                        <div class="form-group">
                            <p>Phone</p>
                            <input type="text" class="form-control border-dark @error('phone') is-invalid @enderror" name="phone" pattern="[0-9]{10}" maxlength="10" value="{{ old('phone') }}">
                            <!-- ... -->
                        </div>
                        <div class="form-group">
                            <p>Address</p>
                            <input type="text" class="form-control border-dark @error('address') is-invalid @enderror" name="address" value="{{ old('address') }}">
                            <!-- ... -->
                        </div>
                        <div class="form-group">
                            <p>Email</p>
                            <input type="email" class="form-control border-dark @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}">
                            <!-- ... -->
                        </div>
                        <div class="form-group">
                            <p>Password</p>
                            <input type="password" class="form-control border-dark @error('password') is-invalid @enderror" name="password">
                            <!-- ... -->
                        </div>
                        <div class="form-group">
                            <p>Confirm Password</p>
                            <input type="password" class="form-control border-dark @error('password_confirmation') is-invalid @enderror" name="password_confirmation">
                            <!-- ... -->
                        </div>
                        <div class="form-group">
